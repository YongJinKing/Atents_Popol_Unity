...
public class cameraMove : MonoBehaviour
{
    ...
    public float rotationSpeed = 0.1f; // ?åÏ†Ñ ?çÎèÑ
    private Vector3 lastMousePosition; // ÎßàÏö∞???¥Ï†Ñ ?ÑÏπò
    ...
    void Update()
    {
        ...
        if (!isCine)     //ÎßàÏö∞???ÖÎ†•Í≥?Í¥Ä?®Îêú ÏΩîÎìú
        {
            //?§ÌÅ¨Î°?Ï§?
    ...
    {
        //?åÎ†à?¥Ïñ¥??Î™¨Ïä§?∞Í? Ï£ΩÏóà?ÑÏãú???§Ìñâ ?òÎäî ?®Ïàò
        // Unit = 0 ?ºÎïå Î™¨Ïä§??Unit = 1 ?ºÎïå ?åÎ†à?¥Ïñ¥
        isCine = true;
        isTracking = false;
